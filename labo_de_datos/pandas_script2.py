...
#%% para agregar una nueva fila (alumno nuevo)

alu_nue = {'lu':['123/45'], 'nombre':['Juan'], 'apellido':['Pérez'],'nota1':[2], 'nota2':[10]}
...
df_nuevo.loc['123/45','promedio'] = (df_nuevo.loc['123/45','nota1'] + df_nuevo.loc['123/45','nota2'])/2
